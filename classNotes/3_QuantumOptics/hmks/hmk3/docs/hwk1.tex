...
\begin{align*}
    ...
    Y^m_l\qty(\theta,\phi) &=\sqrt{\frac{\qty(2l+1)}{4\pi}\frac{\qty(l-\abs{m})!}{\qty(l+\abs{m})!}}e^{im\phi}P^m_l\qty(\cos\qty[\theta]) 
\end{align*}
to construct $Y^0_0$ and $Y^1_2$.
Check that they are normalized and orthogonal.

\begin{sol}{Spherical harmonic}{label-4}
    We start with $Y^0_0\qty(\theta,\phi)$, $m=l=0$ which gives that, $P^0_0(x)=P_0(x)=1$, hence,
    \begin{align*}
    ...
    \begin{align*}
        Y^1_2\qty(\theta,\phi) &=\sqrt{\frac{5}{4\pi}\frac{1}{6}}e^{i\phi}\sqrt{1-x^2}\dv{x}\frac{1}{2}\qty(3x^2-1)\qty(\cos\qty[\theta]) \\
                               &=\sqrt{\frac{5}{4\pi}\frac{1}{6}}e^{i\phi}\sqrt{1-x^2}3x
    \end{align*}
