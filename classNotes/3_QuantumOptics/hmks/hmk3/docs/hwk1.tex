...
\begin{sol}{Spherical harmonic}{label-4}
   ...
   and 
    ...
    and
    \begin{align*}
        P^1_2(x)&\equiv\qty(1-x^2)^{\abs{1}/2}\qty(\dv{x})^{\abs{1}}P_2(x)=3x\sqrt{1-x^2}
    \end{align*}

    \begin{align*}
        Y^1_2\qty(\theta,\phi) &=\sqrt{\frac{\qty(2(2)+1)}{4\pi}\frac{\qty(2-\abs{1})!}{\qty(2+\abs{1})!}}e^{im\phi}P^1_2\qty(\cos\qty[\theta]) \\ 
                               &=\sqrt{\frac{5}{4\pi}\frac{1}{6}}e^{i\phi}3\cos\qty[\theta]\sqrt{1-\cos^2\qty[\theta]} \\
                               &=\sqrt{\frac{5}{24\pi}}e^{i\phi}3\cos\qty[\theta]\sqrt{\sin^2\qty[\theta]}.
    \end{align*}
