...
function computeHamiltonianThreads(J,B,sys,part,Ng)
    """
...
function metropoliAlgorithm(σ,Nsteps,part,J,B,kb,T,Ng)
    ...
    d = Functions.computeHamiltonianThreads(J,B,σ,part,Ng);
    energ[auxs] = 0;#first(d);
    mag[auxs] = last(d);
