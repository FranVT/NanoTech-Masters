...
env OMP_RUN_THREADS=2 mpirun -np 8 lmp -sf omp -in in.assemblyShear.lmp -var L 9.99857 -var NCL 225 -var NMO 1275 -var seed1 1234 -var seed2 4321 -var seed3 3124 -var steps 2000000 -var tstep 0.005 -var sstep 10000
