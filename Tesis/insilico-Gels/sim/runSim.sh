...
cp -r info ..;
cd ..;
mv -f info data/storage/systemTotalFreePhi550T50damp1000cCL20NPart500ShearRate10RT1_600RT2_1200RT3_2400RT4_7200Nexp3;
cd data/storage/systemTotalFreePhi550T50damp1000cCL20NPart500ShearRate10RT1_600RT2_1200RT3_2400RT4_7200Nexp3/info; mv dumps ..; cd ..; cd ..; cd ..; cd ..;
