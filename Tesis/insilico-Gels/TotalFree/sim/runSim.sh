...
cp -r info ..;
cd ..;
mv -f info data/storage/systemTotalFreePhi550T50damp100cCL180NPart1500ShearRate20RT1_150RT2_300RT3_600RT4_1200;
cd data/storage/systemTotalFreePhi550T50damp100cCL180NPart1500ShearRate20RT1_150RT2_300RT3_600RT4_1200/info; mv dumps ..; cd ..; cd ..; cd ..; cd ..;
