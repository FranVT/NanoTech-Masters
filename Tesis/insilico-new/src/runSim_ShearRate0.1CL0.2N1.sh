...
mv -f data.firstShear data/storage/systemTotalFreePhi2500NPart1000damp5000T500cCL2000ShearRate1000-Nexp1/info;
mv -f data.hydrogel data/storage/systemTotalFreePhi2500NPart1000damp5000T500cCL2000ShearRate1000-Nexp1/info;
