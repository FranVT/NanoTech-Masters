...
# Indixes
 # Indixes for non stress fix files
      ind_heat=Int64.(1:1:parameters.N_heat/parameters.N_savefix);#,
      ind_isothermal=last(ind_heat).+Int64.(1:1:parameters.N_iso/parameters.N_savefix);
      ind_deform1=last(ind_isothermal).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savefix);
      ind_rlx1=last(ind_deform1).+Int64.(1:1:parameters.N_rlx1/parameters.N_savefix);
      ind_deform2=last(ind_rlx1).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savefix);
      ind_rlx2=last(ind_deform2).+Int64.(1:1:parameters.N_rlx2/parameters.N_savefix);
      ind_deform3=last(ind_rlx2).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savefix);
      ind_rlx3=last(ind_deform3).+Int64.(1:1:parameters.N_rlx3/parameters.N_savefix);

# Indixes for stress fix files
      ind_heat_s=Int64.(1:1:parameters.N_heat/parameters.N_savestress);
      ind_isothermal_s=last(ind_heat_s).+Int64.(1:1:parameters.N_iso/parameters.N_savestress);
      ind_deform1_s=last(ind_isothermal_s).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savestress);
      ind_rlx1_s=last(ind_deform1_s).+Int64.(1:1:parameters.N_rlx1/parameters.N_savestress);
      ind_deform2_s=last(ind_rlx1_s).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savestress);
      ind_rlx2_s=last(ind_deform2_s).+Int64.(1:1:parameters.N_rlx2/parameters.N_savestress);
      ind_deform3_s=last(ind_rlx2_s).+Int64.(1:1:parameters.Ncycles*parameters.N_deform/parameters.N_savestress);
      ind_rlx3_s=last(ind_deform3_s).+Int64.(1:1:parameters.N_rlx3/parameters.N_savestress);

      inds=(
           heat=ind_heat, #Int64.(1:1:parameters.N_heat/parameters.N_savefix),
           isothermal=Int64.(parameters.N_heat/parameters.N_savefix).+Int64.(1:1:parameters.N_iso/parameters.N_savefix),
           assembly=reduce(vcat,[ind_heat,ind_isothermal]),
           deform1=ind_deform1, #Int64.(parameters.N_iso/parameters.N_savefix).+Int64.(1:1:parameters.N_deform/parameters.N_savefix),
           rlx1=ind_rlx1, #Int64.(parameters.N_iso/parameters.N_savefix+parameters.N_deform/parameters.N_savefix).+Int64.(1:1:parameters.N_rlx1/parameters.N_savefix),
           deform2=ind_deform2,
           rlx2=ind_rlx2,
           deform3=ind_deform3,
           rlx3=ind_rlx3,
           shear=reduce(vcat,[ind_deform1,ind_rlx1,ind_deform2,ind_rlx2,ind_deform3,ind_rlx3]),
           heat_s=ind_heat_s,
           ...
           rlx3_s=ind_rlx3_s,
           shear_s=reduce(vcat,[ind_deform1_s,ind_rlx1_s,ind_deform2_s,ind_rlx2_s,ind_deform3_s,ind_rlx3_s])
          );
...
data_energy_shear=map([file_dir[7]]) do r
    ...
    (
     ...
     data_Tdef=data_aux[6,:],
     data_Pot=data_aux[3,:],
     data_Kin=data_aux[4,:],
     data_pressure=data_aux[5,:],
     data_Eng=data_aux[3,:].+data_aux[4,:]
   );
end
...
info_shear=(
            # Energy file
             ...
             tpcm=reduce(vcat,mean(reduce(hcat,map(s->s.data_Tdef,data_energy_shear)),dims=2)),
...
info=(
     ...
     tpcm=append!(info_assembly.temp,info_shear.tpcm),
