...
\usepackage{amsfonts}        % Instruction : \mathbb
\usepackage{amssymb}         % Instruction : \triangleq
...
\include{chs/ch1}      % Chapter 1 Name
\include{chs/ch2}      % Chapter 2 Name
\include{chs/ch3}      % Chapter 3 Name
%\include{chs/ch4}      % Chapter 4 Name
\include{chs/ch5}      % Chapter 5 Name
...
\bibliography{MyBiblio}     % names file phdrefs.bib as my bibliography file
