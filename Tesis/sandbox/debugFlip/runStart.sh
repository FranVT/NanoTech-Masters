...
L_real=$(echo "scale=$cs; e( l($Vol_Tot^(1/3)) )" | bc -l );
...
dir_name=""debugSwap"${phi_aux}"NPart"${N_particles}"damp"${damp_aux}"T"${T_aux}"cCL"${CL_con}"ShearRate"${shear_aux}"-Nexp"${Nexp}";
