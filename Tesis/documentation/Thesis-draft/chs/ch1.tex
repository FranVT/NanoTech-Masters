...
Delveving into more specific viscoelastic properties, figure~\ref{fig:mechresponse0-b} shows the creep and stress relaxation strain-stress relation for viscoelastic response.
It is understood that a more viscoelatic response is related with an increase in the strain value at a constant applied force.
...
In hydrogels an important factor influencing viscoelastic behaviour is the strength of the crosslinking mechanisms in the network.
...
In this regard, the key point for the thesis is to explore how molecular dynamics can be used to determine the extent to which the mechanical response of hydrogels can be explained by the topological features of the polymeric networks.
...
In the following chapter the mathematical tools that enable us to quantify this relationship are explained and a more detail exploration of the hydrogel's mechanical response is given.
Then a comprehensive explanation of how these relationships can be simulated using molecular dynamics is given.
To finish, the numerical results are presented in comparisson with reported information.
