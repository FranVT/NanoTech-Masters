...
\begin{figure}[ht!]
    ...
    \caption{Chosen examples of tough hydrogels applied in the areas of a) tissue engineering, b) soft electronics, c) shape memory materials, d) 3D printing, e) biomedical devices, and f) adhesives. Notably, the majority of the highlighted examples ultimately serve biomedical applications\citep{petelinsekToughHydrogelsLoadBearing2024}.}
\end{figure}
