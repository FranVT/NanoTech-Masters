...
This continuous viscous deformation is known as ``creep'' and it occurs when a constant stress is applied over a long period or the temperature is sufficiently high~\citep{khaliliNanoindentationResponse3D2023,wangHyperelasticSwellingTough2024}.
Furthermore, when subjected to a constant strain, viscoelastic materials experience ``stress relaxation'', whereby stress decreases over time after the yield point~\citep{chaudhuriHydrogelsTunableStress2016}.
