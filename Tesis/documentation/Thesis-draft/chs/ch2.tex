...
%\paragraph{Intro}
In this section there is going to be a brief literature review of the reported mechanical response of hydrogel, with the focus on searching for a connection between the structural properties on a molecular level and the mechanical properties of the macroscopic hydrogel.
