...
According to the literature, crosslinking mechanisms are typically classified as physical or covalent crosslinkers since the basic principles of the crosslink mechanism are either physical interactions or covalent bonds.
...
\begin{figure}[!ht]
    ...
    \caption{In a main-chain polyrotaxane, the m rings can move in the same way that tiny molecules can, but across larger distances, depending on the number of rings.
...
In contrast, a high-energy external stimulus activates the crosslinker mechanisms for ``dynamic'' covalent bonds~\citep{shomePhotoresponsiveSmartHydrogels2024}. % such as imine, boronate ester, thioester, disulfide, and transesterification.
