...
Consequently, the properties of polymer networks exhibit significant variability, contingent on the composition of the junctions and strands, as well as the formation and utilization conditions.}.
...
\paragraph{Gels} Gels are polymer networks form by crosslinks covalent or supremolecular bonds that can swollen in liquid media such as water or organic solvents.
The network structure guarantees that the liquid is retained within the material.
Gels typically exhibit Young's moduli in the range of 103–104 Pa, yet they frequently demonstrate the capacity for substantial deformation.
