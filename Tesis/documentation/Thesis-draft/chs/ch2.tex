...
\begin{figure}[ht!]
    \centering
    \includegraphics[height=6cm]{figs/explainMechResponse/energyDissipationMechanisms.png
}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=6cm]{figs/explainMechResponse/dualNetwork1.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=12cm]{figs/explainMechResponse/RAN-REG-networks.jpeg}
