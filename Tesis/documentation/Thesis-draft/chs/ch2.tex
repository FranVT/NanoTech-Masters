...
% Here resume grammar corrections

\section{Molecular dynamics}

Now that we are familiarized with the mechanical response of the hydrogel and how the macroscopic and microscopic stress tensors are equivalent, in this section, we present the mathematical tools, also known as molecular dynamics (MD), employed to simulate the polymeric network.
