...
\paragraph{About stress relazation in dual networks}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\textwidth]{figs/explainMechResponse/alginateShearThinning.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\textwidth]{figs/explainMechResponse/singleRANtensile.jpeg}
    \caption{Tensile response of random crosslink spatial distribution\citep{kongEffectCrossLinkHomogeneity2024}.}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\textwidth]{figs/explainMechResponse/singleREGtensile.jpeg}
