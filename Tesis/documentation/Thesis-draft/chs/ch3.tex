...
The sixth term considers long-range Coulombic interactions, and the final term considers contributions from \verb|fix| commands such as \verb|fix rigid| or \verb|fix shake|.
...
However, it should be noted that in figure~\ref{fig:stress-strainCLResults}, the greatest stress levels occur before the strain value of $2$, which differs from the earlier cites, which reported that the highest stress occurs at strain values of about $2-3$.
