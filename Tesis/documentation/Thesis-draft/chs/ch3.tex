...
Figure~\ref{fig:patchpatchpot}\footnote{Add the WCA potential} compares the patch-patch interaction potential, the Lennard-Jones potential, and the FENE potential\footnote{Add the FENE definition and clarify why we are comparing with this potential.}.
