...
The central particles of color orange represent the patchy particles with valence \num{2}, while the patchy particles with red central particles are those with valence of \num{4}, as shown in panels a and b.
On panels c and d we can appreciate the swap dynamic allowed by the three-body potential.
On panel c a patchy particle is approaching a pair of bonded patches.
