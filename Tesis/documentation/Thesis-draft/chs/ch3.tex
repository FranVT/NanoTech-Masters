...
In addition, if we let the polymeric network form with only those potentials, the patches are going to form cluster of more than 2 patches, which is not desirable, because it does not follows the single bond per patch condition.
