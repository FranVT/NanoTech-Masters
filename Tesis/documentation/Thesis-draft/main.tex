...
%VimtexCompileSS\bibliographystyle{plain}  % sorted alphabetically, labeled with numbers

%\nocite{*}
\bibliographystyle{ksfh_nat}
\bibliography{biblio.bib}     % names file phdrefs.bib as my bibliography file
