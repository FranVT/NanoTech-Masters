...
\newglossaryentry{K-mr}{
  type=symbolsmr,
  name=$K$,
  description={FENE bond energy (Dimensionless)}
}
\newglossaryentry{Ro-mr}{
  type=symbolsmr,
  name=$R_{o}^{2}$,
  description={Bond distance for FENE interaction (energy/distance$^2$)}
}
\newglossaryentry{w-mr}{
  type=symbolsmr,
  name=$w$,
  description={Threebody tunnign parameter (Dimensionless)}
}
...
\newglossaryentry{T-mr}{
  type=symbolsmr,
  name=$T^{*}$,
  description={Temperature (Dimensionless)}
}
\newglossaryentry{damp-mr}{
  type=symbolsmr,
  name=$\mathrm{damp}$,
  description={Damping coefficient (1/time)}
}
