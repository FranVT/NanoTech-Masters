...
\cor{This thesis modifies a numerical protocol originally designed to simulate microgel particles of PNIPAM using patchy particles to simulate polymeric gels.
    The modifications of the numerical approach allowed the percolation of a patchy particle network at a temperature of \num{0.05}$[T^*]$, with a packing fraction of \num{0.5} and a damp of \num{0.1}$[1/t^*]$ for systems with 3\%, 5\%, and 10\% of crosslinker concentration.
...
On the other hand, by fitting the steady stress after the overshoot with the Hershey-Bulckey, it indicates that the system presents shear thinning and no yield stress; therefore, it is more adequate to refer to it as a viscoelastic fluid than a viscoelastic solid.
