...
\newglossaryentry{dotEps-mech}{
  type=symbolsmech,
  name=\ensuremath{\dot{\bm{s}},~\dot{s_{ij}}},
...
\newglossaryentry{gamma-mech}{
  type=symbolsmech,
  name=$\dot{\gamma}$,
  description={Shear rate (\SI{}{\per\second})}
}
...
\newglossaryentry{rred-mr}{
  type=symbolsmr,
  name=$r^{*}$,
  description={Reduce distance ($r/O$  Adimensional)}
}
