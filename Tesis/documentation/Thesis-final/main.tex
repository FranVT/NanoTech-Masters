...
\cor{This thesis modifies a numerical protocol design to simulate microgel particles of PNIPAM using patchy particles to simulate polymeric gels.
The modifications of the numerical approach allowed the percolation of a patchy particle network at a temperature of \num{0.05}$[T^*]$, with a packing fraction of \num{0.5} and a damp of \num{0.1} for systems with 3\%, 5\%, and 10\% of crosslinker concentration.
...
However, the maximum of the network is achieved at lower strains in contrast to those reported in the literature.
