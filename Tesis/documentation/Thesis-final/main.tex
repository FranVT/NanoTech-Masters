...
\newglossaryentry{sigma-mr}{
  type=symbolsmr,
  name=$\sigma^*$,
  description={Particle diameter (Length)}
}
\newglossaryentry{rred-mr}{
  type=symbolsmr,
  name=$r^{*}$,
  description={Reduce distance ($r/\sigma^*$  Adimensional)}
}
\newglossaryentry{e-mr}{
  type=symbolsmr,
  name=$\epsilon^{*}_{ij}$,
  description={Energy of interaction (Dimensionless)}
}
...
\newglossaryentry{Ro-mr}{
  type=symbolsmr,
  name=$R_{o}^{2}$,
  description={Bond distance for FENE interaction (Dimensionless)}
}
