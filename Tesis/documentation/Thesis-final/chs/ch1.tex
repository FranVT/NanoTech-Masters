...
The research, conducted over two years, establishes a basis for further research, including \cor{the specialization of the methodology for hydrogels to aid the design of this material for a desired application with specific mechanical performance requirements.}
...
To align with the institution's research, the computational approach was adjusted to simulate polymeric gels for gradual methodology modification for hydrogels.
...
Meanwhile, gels are polymer networks formed through covalent or supramolecular bonds and are swollen in liquid media, including water or organic solvents\citep{guPolymerNetworksPlastics2020}.}

\cor{This technique is flexible enough to allow for the necessary adjustments to create a polymeric network, rather than a cross-linked polymer network at the colloidal scale. 
...
Secondly, it should conform to the institution's strategic research priorities in biological applications.
...
\cor{This explanation is of great relevance; for instance, cells react to the rigidity of their surroundings by mechanotransduction, necessitating an ideal elastic modulus (G') to direct stem cell behavior and preserve distinct cell phenotypes. 
