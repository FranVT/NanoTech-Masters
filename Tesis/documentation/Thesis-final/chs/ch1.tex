...
\cor{Gels are non-fluid colloidal or polymeric networks that can grow across their entire volume by incorporating a fluid~\citep{IUPACG026002025}.
This work focuses on polymeric gels, which are polymer networks created by covalent or supramolecular interactions and can swollen in liquid media, such as water or organic solvents~\citep{guPolymerNetworksPlastics2020}.}
\cor{A hydrogel is a material characterized by a three-dimensional crosslinked polymer network capable of absorbing substantial amounts of water.
The numerical protocol in which this work is based originally designed to simulate PNIPAM microgels was adapted to model polymeric gels.
...
%This because microgels are colloidal-scale particles composed of cross-linked polymer networks that can swell and deswell in response to external stimuli~\citep{gnanSilicoSynthesisMicrogel2017}.
...
Hydrogels can efficiently eliminate many hazardous substances, including heavy metals, organic contaminants, and pathogens from water sources.
The review~\citep{randoFunctionalBioBasedPolymeric2024} examines the growing trend of stimuli-responsive smart hydrogels, highlighting their potential for the adsorption and detection of water pollutants.
 An instance is presented in reference~\citep{cinfrigniniGoldRushDesigning2024}, which examines the facile synthesis of poly(acrylamide-co-acrylic acid) hydrogels as adsorbents for the recovery of gold from industrial wastewater including additional precious metals.
Furthermore, reviews~\citep{darbanHydrogelBasedAdsorbentMaterial2022a,songSynthesisHydrogelsTheir2022} elucidate the synthesis and adsorption mechanisms, crosslinking techniques, associated limitations, and significant contributions of hydrogel-based adsorbent materials in the removal of environmental pollutants.

%\paragraph{Medical applications} 
Additionally, hydrogels are attracting significant interest in the biomedical sector due to their elevated water content, biocompatibility, and integration capabilities with biological systems.
Reference~\citep{wuAdvancementsHydrogelsCorneal2024} examines hydrogels and their importance in corneal tissue engineering.  
It also examines other formats, including stimuli-responsive variants.  
 Reference~\citep{kaurHydrogelsPotentialBiomaterial2024} elucidates recent compelling uses of bioactive hydrogels in antibacterial wound healing, oral drug delivery, cancer immunotherapy, tissue regeneration, and associated biomedical domains.  
 Reference~\citep{thummaIntroductionClassificationApplications2025} examines the production and medical applications of several naturally occurring and synthetic hydrogels for cancer treatment, mostly utilizing 3D modeling and printing techniques.
...
\begin{figure}[ht!]
    ...
    \caption{Situations of adaptable hydrogels utilized in the fields of (a) tissue engineering, (b) soft electronics, (c) shape memory materials, (d) 3D printing, (e) biomedical devices, and (f) adhesives. 
    The majority of the mentioned examples possess biomedical applications.\citep{petelinsekToughHydrogelsLoadBearing2024}.}\label{fig:applications}
\end{figure}
