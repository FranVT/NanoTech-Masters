...
Therefore, the primary objective of this thesis is to explore a computational methodology that can identify parameters \cor{to model} the key properties of the polymeric network. 
...
\end{itemize}
The analysis is expected to help select one or more parameters that can later be incorporated into a constitutive equation \cor{How}.
...
\cor{Start by defining what is a hydrogel}

While the numerical protocol was initially developed to simulate microgels \cor{Which microgels}, it was modified to represent a broader group of polymeric networks known as hydrogels.
...
The material's viscoelastic response makes it suitable for use in shock absorption, vibration damping, and biological tissue mimicry\cor{Reference.}.
