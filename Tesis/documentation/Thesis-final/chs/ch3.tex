...
Thus, this corroborates the interpretation of network fragmentation, as systems demonstrating shear thinning are explained by network fragmentation.
...
In table~\ref{tab:fitParameters} are reported the numeric values of the fit~\eqref{eqn:fit} for each system with different crosslinker concentration.}
\begin{table}[ht!]
\centering
