...
Moreover, the strain shift at peak load is imperceptible.
\cor{This signifies an difference in our numerical results.
This indicates that the network lacks the elasticity observed in the literature, which can be attributed to the value of the damping parameter.}
