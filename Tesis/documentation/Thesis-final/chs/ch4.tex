...
\cor{This study attempts to simulate a hydrogel, through molecular dynamics, by using patchy particles to model the polymer network of monomers and crosslinkers. 
This work concentrates exclusively on systems with physical crosslinking by selecting a potential interaction that permits the break-up and reformation of the bonds.
The study also demonstrates that numerical simulations are applicable for analyzing mechanical responses under substantial strains.}
...
\cor{A shear thinning response has been observed across all systems from the strain-stress relationships.
...
\cor{An other critical subject to consider is the simulations were carried out at low damping and high packing fraction.
...
\cor{This work establishes preiliminary steps towards the simulation of dispersed polymeric networks. 
However, the following analysis is required to obtain definitive results. }
\cor{Characterize the network, including pore size, cluster size, strand length, percentage of dangling strands and loops, and other topological metrics.
