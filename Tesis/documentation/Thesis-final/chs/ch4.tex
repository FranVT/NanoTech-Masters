...
\cor{The remanning analysis is to characterize the network, including pore size, cluster size, strand length, percentage of dangling strands and loops, and other topological metrics.
