...
\begin{figure}[ht!]
    ...
    \caption{Deformation of an infinitesimal rectangular material element. Image retrieved from~.}\label{fig:strainTensor}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption{The traction vectors are represented by blue arrows in each surface of the cube.
        ...
        Image retrieved from~.}\label{fig:stressTensor}
\end{figure}
