...
However, research has shown that regardless of the crosslink mechanism, the network can exhibit dynamic behavior~\citep{hanDynamicCovalentHydrogels2022} (\cor{How?}). 
...
This high-energy (\cor{Add exmaples}) external stimulus may encourage the formation of new bonds prior to the dissolution of existing ones, or it may encourage the dissolution of existing ties prior to the formation of new ones.
