...
After that, they expand both kinds of networks in a monomer and cross-linker mixture, which is then polymerized to create double networks. 
This is to investigate how cross-link homogeneity affects regular and random networks' strain stiffening behavior.
...
\begin{figure}[ht!]
    ...
    \caption{\cor{Variation of stationary shear viscosity with shear rate in aqueous sodium alginate solutions across different concentrations in the semi-dilute and concentrated regimes.
    Solid lines correspond to the fitting of experimental data by Cross model~\citep{varela-feijooMultiscaleInvestigationViscoelastic2023}.}}\label{fig:hydroMechResponse2}
\end{figure}
