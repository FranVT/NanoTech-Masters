...
\subsection{\cor{Strain stifeening in dual networks}}

According to reference~\citep{kongEffectCrossLinkHomogeneity2024}, they fabricate randomly cross-linked networks of poly(n-butyl acrylate) using thermally induced free-radical polymerization and routinely cross-linked networks via thiol-bromine coupling of tetrafunctional poly(n-butyl acrylate) star polymers.
Subsequently, they enhance both types of networks within a monomer and cross-linker combination, which is subsequently polymerized to form double networks. 
This study aims to examine the influence of cross-link homogeneity on the strain stiffening behavior of regular and random networks.
...
Randomly cross-linked networks generally display a polydisperse distribution of strand lengths, marked by a considerable fraction of short strands, resulting in strain hardening at relatively low extensions. 
Conversely, regular networks exhibit a significantly narrower distribution of predominantly higher molecular weight strands and are anticipated to show notably delayed strain stiffening relative to comparable random networks.
