...
\section{Hydrogels}\label{ch2:Hydrogels}
...
Furthermore, crosslinking affects various physical properties of the hydrogel, such as elasticity, viscosity, solubility, glass transition temperature, strength, toughness, and melting point\citep{priyaComprehensiveReviewHydrogel2024}.
...
Since we are interested in the mechanical response of the material, our focus will be in the crosslinking mechanisms.
...
Crosslinking involves the formation of chemical bonds between polymer chains, creating a three-dimensional network structure\citep{priyaComprehensiveReviewHydrogel2024}. 
